// OptionBalloon.h: interface for the COptionBalloon class.
//
//////////////////////////////////////////////////////////////////////
...
#if !defined(gS_OptionBalloon_DEFINED)
#define gS_OptionBalloon_DEFINED
...
typedef long (__stdcall *pOptionNoModal) (long, long, long);
...
class COptionBalloon : public CBalloonWnd  
{
public:
	...
	COptionBalloon();
	virtual ~COptionBalloon();

	// Generated message map functions
protected:
	//{{AFX_MSG(COptionBalloon)
...
public:
	...
	void SetCheckBoxState(BOOL bCheck = TRUE);
	...
	pOptionNoModal OptionNoModal; // Callback function
...
#endif // !defined(gS_OptionBalloon_DEFINED)
